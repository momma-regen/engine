...
class Menu(Obj):
    ...
    def m_open(self):
        ...
        mouse.set_visible(True) #add custom cursor icon options
    ...
    def collision(self):
        ...
        for control in self._controls:
            if control.col(0).check(m_col): 
                col_list.append((control, 0))
                break
        # Formatted to keep standard with level collision function. 
